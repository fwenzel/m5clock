...
// This script turns quotes from books into images for use on an eink clock.
// based on code by Jaap Meijers, 2018
...
function TurnQuoteIntoImage($time, $quote, $timestring, $title, $author) {
    ...
    if ( $metawidth > 500 ) {
        ...
        imagettftext($png_image, $creditFont_size, 0, $metadataX1, $metadataY-round($textheight1*1.1), $black, $creditFont, $dash . $newCredits[0]);
